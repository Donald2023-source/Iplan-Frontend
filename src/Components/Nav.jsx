...
import { FaBars, FaBookReader, FaHome, FaUserAlt } from "react-icons/fa"
...
const Nav = () => {
    ...
    return (
        <>
        <div>
            <nav className="flex justify-between px-5 lg:px-20 bg-white py-4 shadow items-center">
                <h2 className="text-xl">Ipan</h2>
